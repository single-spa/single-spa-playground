  ...
  return (
    <>
      ...
      <article className="card" {...scope}>
        <section>
          It's time to talk about the HTML file. In single-spa, there is only
        ...
        <section>
          ...
          entirely. You will want to put this HTML file into its own git repo,
          not one of the application repos.
        </section>
        ...
        <div>
          ...
          your single-spa root config, separate from your applications. Then,
          copy the html below into a file called <code>index.html</code> and run{" "}
          <code>npx serve -s</code> from the same directory as the html file.
          You should now be able to see your application working locally!
        </div>
